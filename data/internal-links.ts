...
export const serviceClusterLinksBySlug: Record<string, InternalLink[]> = {
  ...
  "commercial-electrician-sydney": [
    ...
    { href: "/services/strata-electrician-sydney", label: "Strata electrician Sydney" },
    { href: "/services/property-management-electrician-sydney", label: "Property management electrician Sydney" },
  ...
  "strata-electrician-sydney": [
    { href: "/service-areas", label: "Strata electrician service areas" },
    { href: "/services/commercial-electrician-sydney", label: "Commercial electrician Sydney" },
    { href: "/services/property-management-electrician-sydney", label: "Property management electrician Sydney" },
    { href: "/services/electrical-fault-finding-sydney", label: "Common-area electrical fault finding" },
    { href: "/services/emergency-exit-lighting-sydney", label: "Emergency and exit lighting" },
  ...
  "property-management-electrician-sydney": [
    { href: "/service-areas", label: "Property management electrician service areas" },
    { href: "/services/commercial-electrician-sydney", label: "Commercial electrician Sydney" },
    { href: "/services/strata-electrician-sydney", label: "Strata electrician Sydney" },
    { href: "/services/pre-purchase-rental-electrical-inspections-sydney", label: "Rental electrical inspections" },
    { href: "/services/smoke-alarm-electrician-sydney", label: "Smoke alarm electrical work" },
    { href: "/services/electrical-fault-finding-sydney", label: "Managed-property fault finding" },
  ],
