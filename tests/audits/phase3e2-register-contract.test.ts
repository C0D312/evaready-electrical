...
test("current register preserves historical release deltas and the fifty-five unpublished editorial exceptions", () => {
...
test("all fifty-five editorial rows reject invented publication and cleared owner holds", () => {
