...
test("current register preserves historical release deltas and the fifty-six unpublished editorial exceptions", () => {
...
test("all fifty-six editorial rows reject invented publication and cleared owner holds", () => {
