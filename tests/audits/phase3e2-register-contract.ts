...
export const editorialMilestone17Routes = new Set([
  "/service-areas/canterbury-bankstown-and-inner-south-west/canterbury-bankstown/sefton",
  "/service-areas/canterbury-bankstown-and-inner-south-west/canterbury-bankstown/birrong",
  "/service-areas/parramatta-and-cumberland/cumberland/regents-park",
  "/service-areas/canterbury-bankstown-and-inner-south-west/canterbury-bankstown/potts-hill",
  "/service-areas/canterbury-bankstown-and-inner-south-west/canterbury-bankstown/villawood",
]);
export const editorialMilestone18Cohort01Routes = new Set([
  "/service-areas/canterbury-bankstown-and-inner-south-west/canterbury-bankstown/georges-hall",
  "/service-areas/canterbury-bankstown-and-inner-south-west/canterbury-bankstown/milperra",
  "/service-areas/canterbury-bankstown-and-inner-south-west/canterbury-bankstown/mount-lewis",
  "/service-areas/parramatta-and-cumberland/cumberland/berala",
]);
export const editorialMilestone18Cohort02Routes = new Set([
  "/service-areas/parramatta-and-cumberland/cumberland/girraween",
  "/service-areas/parramatta-and-cumberland/cumberland/holroyd",
]);
export const editorialMilestone18Cohort03Routes = new Set([
...
export const editorialMilestone19Cohort02Routes = new Set([
  "/service-areas/parramatta-and-cumberland/parramatta/old-toongabbie",
  "/service-areas/parramatta-and-cumberland/parramatta/rosehill",
  "/service-areas/parramatta-and-cumberland/parramatta/rydalmere",
  "/service-areas/parramatta-and-cumberland/parramatta/silverwater",
  "/service-areas/parramatta-and-cumberland/parramatta/sydney-olympic-park",
]);
export const editorialMilestone19Cohort03Routes = new Set([
  "/service-areas/parramatta-and-cumberland/parramatta/telopea",
  "/service-areas/parramatta-and-cumberland/parramatta/wentworth-point",
  "/service-areas/western-sydney-and-nepean/blacktown/acacia-gardens",
  "/service-areas/western-sydney-and-nepean/blacktown/arndell-park",
  "/service-areas/western-sydney-and-nepean/blacktown/bidwill",
]);
export const editorialMilestone19Cohort04Routes = new Set([
  "/service-areas/western-sydney-and-nepean/blacktown/blackett",
  "/service-areas/western-sydney-and-nepean/blacktown/bungarribee",
  "/service-areas/western-sydney-and-nepean/blacktown/colebee",
...
export const editorialMilestone20Cohort01Routes = new Set([
  "/service-areas/western-sydney-and-nepean/blacktown/hebersham",
  "/service-areas/western-sydney-and-nepean/blacktown/kellyville-ridge",
  "/service-areas/western-sydney-and-nepean/blacktown/kings-langley",
  "/service-areas/western-sydney-and-nepean/blacktown/kings-park",
]);
export const editorialMilestone20Cohort02Routes = new Set([
  "/service-areas/western-sydney-and-nepean/blacktown/lalor-park",
  "/service-areas/western-sydney-and-nepean/blacktown/lethbridge-park",
  "/service-areas/western-sydney-and-nepean/blacktown/marayong",
  "/service-areas/western-sydney-and-nepean/blacktown/marsden-park",
]);
export const editorialMilestone20Cohort03Routes = new Set([
  "/service-areas/western-sydney-and-nepean/blacktown/mount-druitt",
  "/service-areas/western-sydney-and-nepean/blacktown/oakhurst",
  "/service-areas/western-sydney-and-nepean/blacktown/parklea",
  "/service-areas/western-sydney-and-nepean/blacktown/plumpton",
  "/service-areas/western-sydney-and-nepean/blacktown/prospect",
]);
export const editorialRoutes = new Set([...editorialBatch01Routes, ...editorialBatch02Routes, ...editorialBatch03Routes, ...editorialBatch04Routes, ...editorialMilestone07Routes, ...editorialMilestone08Routes, ...editorialMilestone09Routes, ...editorialMilestone10Routes, ...editorialMilestone11Routes, ...editorialMilestone12Routes, ...editorialMilestone13Routes, ...editorialMilestone14Routes, ...editorialMilestone15Routes, ...editorialMilestone16Routes, ...editorialMilestone17Routes, ...editorialMilestone18Cohort01Routes, ...editorialMilestone18Cohort02Routes, ...editorialMilestone18Cohort03Routes, ...editorialMilestone19Cohort01Routes, ...editorialMilestone19Cohort02Routes, ...editorialMilestone19Cohort03Routes, ...editorialMilestone19Cohort04Routes, ...editorialMilestone19Cohort05Routes, ...editorialMilestone20Cohort01Routes, ...editorialMilestone20Cohort02Routes, ...editorialMilestone20Cohort03Routes]);
...
export function registerBeforeEditorialBatch(actual: WholeSiteCompletionRegister): WholeSiteCompletionRegister {
  ...
  assert.equal(editorialMilestone17Routes.size, 5);
  ...
  assert.equal(editorialMilestone20Cohort01Routes.size, 4);
  assert.equal(editorialMilestone20Cohort02Routes.size, 4);
  assert.equal(editorialMilestone20Cohort03Routes.size, 5);
  assert.equal(editorialRoutes.size, 140);
  assert.equal(actual.records.filter(row => editorialRoutes.has(row.route)).length, 140);
  assert.deepEqual(actual.counts.publication, { "live-verified": 861, pending: 140 });
