...
export function emergencySeoMetadata(): RouteSeoMetadata {
  ...
  return {
    path,
    canonical: routeUrl(path),
    title: "Emergency Electrician Sydney | Call 24/7",
    description: clampDescription(
      `Call Evaready for urgent electrical faults in Sydney and surrounding regions. ${business.emergencyResponse.coreDisplay}; ${business.emergencyResponse.greaterDisplay.toLowerCase()}.`,
    ),
  };
}
