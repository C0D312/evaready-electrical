...
const footerColumns: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/service-areas/liverpool-and-fairfield", label: "Liverpool & Fairfield" },
      { href: "/service-areas/macarthur-camden-and-wollondilly", label: "Macarthur, Camden & Wollondilly" },
      { href: "/service-areas/inner-west-burwood-and-canada-bay", label: "Inner West, Burwood & Canada Bay" },
      { href: "/service-areas/sydney-city-and-eastern-suburbs", label: "Sydney City & Eastern Suburbs" },
      { href: "/service-areas/parramatta-and-cumberland", label: "Parramatta & Cumberland" },
      { href: "/service-areas/western-sydney-and-nepean", label: "Western Sydney & Nepean" },
      { href: "/service-areas/hills-hawkesbury-and-hornsby", label: "Hills, Hawkesbury & Hornsby" },
      { href: "/service-areas/northern-sydney-and-ryde", label: "Northern Sydney & Ryde" },
      { href: "/service-areas/northern-beaches", label: "Northern Beaches" },
      { href: "/service-areas/blue-mountains", label: "Blue Mountains" },
      { href: "/service-areas/wollongong-and-illawarra", label: "Wollongong & Illawarra" },
      { href: "/service-areas/southern-highlands", label: "Southern Highlands" },
      { href: "/service-areas/central-coast-south", label: "Central Coast South" },
    ],
  },
  {
