...
Generated: 2026-08-07T20:22:11.711Z
...
- Generated suburb pages: **873/873**.
- Pages with both Call and Quote pathways: **873/873**.
- Internal-link depth distribution: **2 clicks: 90, 3 clicks: 388, 4 clicks: 395**.
- Unique internal links per page, average / median / range: **21.0 / 21.0 / 21-21**.
- Visible words, average / median / range: **901.5 / 901.0 / 879-945**.
- Raw HTML KB, average / median / range: **249.1 / 249.0 / 247.8-251.0**.
...
- Pages with genuinely different completed-service information: **0**.
- Pages with no owner-specific evidence beyond approved coverage facts: **873**.

All pages currently provide correct suburb/postcode hierarchy, response classification, service pathways, nearby links and conversion actions. Those are useful technical and navigation facts, but they are not evidence of work completed in a suburb. No job, photograph or testimonial is published by the new framework because no approved record exists.
